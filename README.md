...
Following values are returned from reportWebVitals();
* LCP Largest Contentful Paint = 317.7
* FID First Input Delay = 2.5
* CLS Cumulative Layout Shift = 0.03892614000823356

# Boilerplate create-react-app below
